...
tf.app.flags.DEFINE_integer(
    'num_epochs', 15, 'The number of epochs for training.')
...
train_data = {}
path_tableaux = '/data/zming/datasets/lipsyn'

train_arr = []
#train_arr = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_1.npy')
train_arr = np.load(os.path.join(path_tableaux, 'train/train_images_array_file_merge.npy'))
train_arr_plus = np.load(os.path.join(path_tableaux, 'test_LRW/test_images_array_file_merge.npy'))
train_arr = np.row_stack((train_arr, train_arr_plus))  
'''arr_1 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_1.npy')
arr_2 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_2.npy')
arr_3 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_3.npy')
arr_4 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_4.npy')
arr_5 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_5.npy')
arr_6 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_6.npy')
arr_7 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_7.npy')
arr_8 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_8.npy')
arr_9 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_9.npy')
arr_10 = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_images_array_file_10.npy')
...
train_arr_audio = []
#train_arr_audio = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_audio_array_file.npy')
train_arr_audio = np.load(os.path.join(path_tableaux, 'train/train_audios_array_file_merge.npy'))
train_arr_audio_plus = np.load(os.path.join(path_tableaux, 'test_LRW/test_audios_array_file_merge.npy'))
train_arr_audio = np.row_stack((train_arr_audio, train_arr_audio_plus))  

test_arr = []
#test_arr = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/test_images_array_file.npy')
#test_arr = np.load(os.path.join(path_tableaux, 'test_collect1/test_images_array_file_merge.npy'))
test_arr = np.load(os.path.join(path_tableaux, 'test_collect/test_images_array_file_merge.npy'))

test_arr_audio = []
#test_arr_audio = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/test_audio_array_file.npy')
#test_arr_audio = np.load(os.path.join(path_tableaux, 'test_collect1/test_audios_array_file_merge.npy'))
test_arr_audio = np.load(os.path.join(path_tableaux, 'test_collect/test_audios_array_file_merge.npy'))

print('---------------------')
print(np.array(train_arr).shape)
print(np.array(train_arr_audio).shape)
print(np.array(test_arr).shape)
print(np.array(test_arr_audio).shape)
train_data = {'mouth': np.array(train_arr), 'speech': np.array(train_arr_audio)}
test_data = {'mouth': np.array(test_arr), 'speech': np.array(test_arr_audio)}
...
train_label = []
#train_label = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/train_lable_array_file.npy')
train_label = np.load(os.path.join(path_tableaux, 'train/train_lables_array_file_merge.npy'))
print(np.array(train_label).shape)
train_label_plus = np.load(os.path.join(path_tableaux, 'test_LRW/test_lables_array_file_merge.npy'))
print(np.array(train_label_plus).shape)
train_label = np.concatenate((train_label, train_label_plus))

train_label = np.array(train_label).reshape(25000, 1)

test_label = []
#test_label = np.load('/home/zhaokaixing/lip-reading-deeplearning/code/training_evaluation/array/test_lable_array_file.npy')
#test_label = np.load(os.path.join(path_tableaux, 'test_collect1/test_lables_array_file_merge.npy'))
test_label = np.load(os.path.join(path_tableaux, 'test_collect/test_lables_array_file_merge.npy'))
#test_label = np.array(test_label).reshape(5000, 1)
#test_label = np.array(test_label).reshape(22, 1)
test_label = np.array(test_label).reshape(40, 1)

log_path = '/data/zming/logs/lip-reading-deeplearning'
#print(train_label)
#print(test_label)
...
def main(_):
    ...
    with graph.as_default(), tf.device('/cpu:0'):
        ...
        num_batches_per_epoch_test = max(int(num_samples_per_epoch_test / FLAGS.batch_size), 1)
    ...
    with tf.Session(graph=graph, config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        ...
        AUC_test_epochs = []
        AP_test_epochs = []
        Score_dissimilarity_vector = np.zeros((FLAGS.num_epochs, num_samples_per_epoch_test))
        for epoch in range(FLAGS.num_epochs):
                ...
                try:
                    ...
                    if (batch_num + 1) % FLAGS.log_every_n_steps == 0:
                        print("Epoch " + str(epoch + 1) + ", Minibatch " + str(
                            ...
                            AUC) + ", AP= " + "{:.5f}".format(AP) + ", contrib = %d pairs" % label_train.shape[0] + ", EER_test= " + str(EER_test) + ", AUC_test= " + str(
                            AUC_test) + ", AP_test= " + str(AP_test))
                except:
                    print("Error: " ,sys.exc_info()[0])
                    print("No contributing impostor pair!")

            # np.save('/home/zming/code/lip-reading-deeplearning/code/training_evaluation/err', eer_array)
            # np.save('/home/zming/code/lip-reading-deeplearning/code/training_evaluation/auc', auc_array)
            # np.save('/home/zming//code/lip-reading-deeplearning/code/training_evaluation/ap', ap_array)
            ...
            score_dissimilarity_vector = np.zeros((num_samples_per_epoch_test, 1))
            label_vector = np.zeros((num_samples_per_epoch_test, 1))
            ...
            for i in range(num_batches_per_epoch_test):
                ...
                loss_value, score_dissimilarity, _ = sess.run([loss, distance_l2, is_training],
                           ...
                           tmux                                               batch_mouth: mouth_test,
                                                                         batch_labels: label_test.reshape(
                                                                             [num_samples_per_epoch_test, 1])})
            ...
            EER_test = np.mean(EER, axis=0)
            AUC_test = np.mean(AUC, axis=0)
            AP_test = np.mean(AP, axis=0)
            Score_dissimilarity_vector[epoch,:] =  score_dissimilarity_vector.flatten()
            EER_test_epochs.append(EER_test)
            AUC_test_epochs.append(AUC_test)
            AP_test_epochs.append(AP_test)
        np.save(os.path.join(log_path, 'Score_dissimilarity_vector'), Score_dissimilarity_vector)
        np.save(os.path.join(log_path, 'EER_test_epochs'), EER_test_epochs)
        np.save(os.path.join(log_path, 'AUC_test_epochs'), AUC_test_epochs)
        np.save(os.path.join(log_path, 'AP_test_epochs'), AP_test_epochs)
